...
- (nonnull instancetype)initWithXVals:(NSArray<NSObject *> * __nullable)xVals dataSets:(NSArray<id <IChartDataSet>> * __nullable)dataSets OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithXVals:(NSArray<NSObject *> * __nullable)xVals;
- (nonnull instancetype)initWithXVals:(NSArray<NSObject *> * __nullable)xVals dataSet:(id <IChartDataSet> __nullable)dataSet;
...
@property (nonatomic, copy) NSArray<id <IChartDataSet>> * __nonnull dataSets;
...
- (id <IChartDataSet> __nullable)getDataSetByLabel:(NSString * __nonnull)label ignorecase:(BOOL)ignorecase;
- (id <IChartDataSet> __null_unspecified)getDataSetByIndex:(NSInteger)index;
- (void)addDataSet:(id <IChartDataSet> __null_unspecified)d;
- (void)handleEmptyAxis:(id <IChartDataSet> __nullable)firstLeft firstRight:(id <IChartDataSet> __nullable)firstRight;
...
- (BOOL)removeDataSet:(id <IChartDataSet> __null_unspecified)dataSet;
...
- (id <IChartDataSet> __nullable)getDataSetForEntry:(ChartDataEntry * __null_unspecified)e;

/// \returns  the index of the provided DataSet inside the DataSets array of this data object. -1 if the DataSet was not found.
- (NSInteger)indexOfDataSet:(id <IChartDataSet> __nonnull)dataSet;

/// \returns  the first DataSet from the datasets-array that has it's dependency on the left axis. Returns null if no DataSet with left dependency could be found.
- (id <IChartDataSet> __nullable)getFirstLeft;

/// \returns  the first DataSet from the datasets-array that has it's dependency on the right axis. Returns null if no DataSet with right dependency could be found.
- (id <IChartDataSet> __nullable)getFirstRight;
...
///
/// \returns  true if so, false if not.
- (BOOL)containsWithDataSet:(id <IChartDataSet> __nonnull)dataSet;
...
- (ChartDataEntry * __nullable)entryForIndex:(NSInteger)i;
...
///
/// \returns  the array-index of the specified entry
- (NSInteger)entryIndexWithEntry:(ChartDataEntry * __nonnull)e;
...
- (BOOL)addEntry:(ChartDataEntry * __nonnull)e;
...
///
/// \returns  true if the entry was added successfully, false if this feature is not supported
- (BOOL)addEntryOrdered:(ChartDataEntry * __nonnull)e;
...
@property (nonatomic, readonly, copy) NSString * __nullable label;

/// The axis this DataSet should be plotted against.
@property (nonatomic, readonly) enum AxisDependency axisDependency;

/// All the colors that are set for this DataSet
@property (nonatomic, readonly, copy) NSArray<UIColor *> * __nonnull colors;
...
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithLabel:(NSString * __nullable)label OBJC_DESIGNATED_INITIALIZER;
...
/// </code>
- (void)setColors:(NSArray<UIColor *> * __nonnull)colors alpha:(CGFloat)alpha;
...
@property (nonatomic, weak) BarLineChartViewBase * __nullable chart;
- (nonnull instancetype)initWithChart:(BarLineChartViewBase * __nonnull)chart OBJC_DESIGNATED_INITIALIZER;
...
///
/// \returns  
- (ChartHighlight * __nullable)getHighlightWithX:(double)x y:(double)y;
...
///
/// \returns  
- (ChartHighlight * __nullable)getStackedHighlightWithOld:(ChartHighlight * __nullable)old set:(BarChartDataSet * __nonnull)set xIndex:(NSInteger)xIndex dataSetIndex:(NSInteger)dataSetIndex yValue:(double)yValue;
...
///
/// \returns  
- (NSInteger)getClosestStackIndexWithRanges:(NSArray<ChartRange *> * __nullable)ranges value:(double)value;
...
///
/// \returns  
- (NSArray<ChartRange *> * __nullable)getRangesWithEntry:(BarChartDataEntry * __nonnull)entry;
- (nonnull instancetype)initWithChart:(BarLineChartViewBase * __nonnull)chart OBJC_DESIGNATED_INITIALIZER;
@end
...
@property (nonatomic, strong) ChartAnimator * __nullable animator;
...
- (void)drawDataWithContext:(CGContextRef __nonnull)context;
- (void)drawDataSetWithContext:(CGContextRef __nonnull)context dataSet:(id <IBarChartDataSet> __nonnull)dataSet index:(NSInteger)index;
- (void)drawValuesWithContext:(CGContextRef __nonnull)context;

/// Draws a value at the specified x and y position.
- (void)drawValueWithContext:(CGContextRef __nonnull)context value:(NSString * __nonnull)value xPos:(CGFloat)xPos yPos:(CGFloat)yPos font:(UIFont * __nonnull)font align:(NSTextAlignment)align color:(UIColor * __nonnull)color;
- (void)drawExtrasWithContext:(CGContextRef __nonnull)context;
- (void)drawHighlightedWithContext:(CGContextRef __nonnull)context indices:(NSArray<ChartHighlight *> * __nonnull)indices;
@end
...
@property (nonatomic, strong) ChartHighlighter * __nullable highlighter;
...
- (id <IBarLineScatterCandleBubbleChartDataSet> __null_unspecified)getDataSetByTouchPoint:(CGPoint)pt;
...
- (void)drawDataWithContext:(CGContextRef __nonnull)context;
- (void)drawDataSetWithContext:(CGContextRef __nonnull)context dataSet:(id <IBubbleChartDataSet> __nonnull)dataSet;
- (void)drawValuesWithContext:(CGContextRef __nonnull)context;
- (void)drawExtrasWithContext:(CGContextRef __nonnull)context;
- (void)drawHighlightedWithContext:(CGContextRef __nonnull)context indices:(NSArray<ChartHighlight *> * __nonnull)indices;
@end
...
- (void)drawHighlightLinesWithContext:(CGContextRef __nonnull)context point:(CGPoint)point set:(id <ILineScatterCandleRadarChartDataSet> __nonnull)set;
@end
...
- (void)drawDataWithContext:(CGContextRef __nonnull)context;
- (void)drawDataSetWithContext:(CGContextRef __nonnull)context dataSet:(id <ICandleChartDataSet> __nonnull)dataSet;
- (void)drawValuesWithContext:(CGContextRef __nonnull)context;
- (void)drawExtrasWithContext:(CGContextRef __nonnull)context;
- (void)drawHighlightedWithContext:(CGContextRef __nonnull)context indices:(NSArray<ChartHighlight *> * __nonnull)indices;
@end
...
+ (UIColor * __nonnull)colorFromString:(NSString * __nonnull)colorString;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
@property (nonatomic, readonly) CGColorRef __nullable color;
@property (nonatomic, readonly) CGGradientRef __nullable gradient;
...
@property (nonatomic, readonly) CGImageRef __nullable image;
@property (nonatomic, readonly) CGLayerRef __nullable layer;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithCGColor:(CGColorRef __nonnull)CGColor OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithColor:(UIColor * __nonnull)color;
- (nonnull instancetype)initWithLinearGradient:(CGGradientRef __nonnull)linearGradient angle:(CGFloat)angle OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithRadialGradient:(CGGradientRef __nonnull)radialGradient startOffsetPercent:(CGPoint)startOffsetPercent startRadiusPercent:(CGFloat)startRadiusPercent endOffsetPercent:(CGPoint)endOffsetPercent endRadiusPercent:(CGFloat)endRadiusPercent OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithRadialGradient:(CGGradientRef __nonnull)radialGradient;
- (nonnull instancetype)initWithCGImage:(CGImageRef __nonnull)CGImage tiled:(BOOL)tiled OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithImage:(UIImage * __nonnull)image tiled:(BOOL)tiled;
- (nonnull instancetype)initWithCGImage:(CGImageRef __nonnull)CGImage;
- (nonnull instancetype)initWithImage:(UIImage * __nonnull)image;
- (nonnull instancetype)initWithCGLayer:(CGLayerRef __nonnull)CGLayer OBJC_DESIGNATED_INITIALIZER;
+ (ChartFill * __nonnull)fillWithCGColor:(CGColorRef __nonnull)CGColor;
+ (ChartFill * __nonnull)fillWithColor:(UIColor * __nonnull)color;
+ (ChartFill * __nonnull)fillWithLinearGradient:(CGGradientRef __nonnull)linearGradient angle:(CGFloat)angle;
+ (ChartFill * __nonnull)fillWithRadialGradient:(CGGradientRef __nonnull)radialGradient startOffsetPercent:(CGPoint)startOffsetPercent startRadiusPercent:(CGFloat)startRadiusPercent endOffsetPercent:(CGPoint)endOffsetPercent endRadiusPercent:(CGFloat)endRadiusPercent;
+ (ChartFill * __nonnull)fillWithRadialGradient:(CGGradientRef __nonnull)radialGradient;
+ (ChartFill * __nonnull)fillWithCGImage:(CGImageRef __nonnull)CGImage tiled:(BOOL)tiled;
+ (ChartFill * __nonnull)fillWithImage:(UIImage * __nonnull)image tiled:(BOOL)tiled;
+ (ChartFill * __nonnull)fillWithCGImage:(CGImageRef __nonnull)CGImage;
+ (ChartFill * __nonnull)fillWithImage:(UIImage * __nonnull)image;
+ (ChartFill * __nonnull)fillWithCGLayer:(CGLayerRef __nonnull)CGLayer;

/// Draws the provided path in filled mode with the provided area
- (void)fillPathWithContext:(CGContextRef __nonnull)context rect:(CGRect)rect;
@end
...
- (CGFloat)getFillLinePositionWithDataSet:(id <ILineChartDataSet> __nonnull)dataSet dataProvider:(id <LineChartDataProvider> __nonnull)dataProvider;
@end
...
@property (nonatomic, strong) ChartLegend * __nullable legend;
...
- (void)drawFormWithContext:(CGContextRef __nonnull)context x:(CGFloat)x y:(CGFloat)y colorIndex:(NSInteger)colorIndex legend:(ChartLegend * __nonnull)legend;

/// Draws the provided label at the given position.
- (void)drawLabelWithContext:(CGContextRef __nonnull)context x:(CGFloat)x y:(CGFloat)y label:(NSString * __nonnull)label font:(UIFont * __nonnull)font textColor:(UIColor * __nonnull)textColor;
@end
...
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithValue:(double)value dataSetIndex:(NSInteger)dataSetIndex dataSet:(id <IChartDataSet> __nonnull)dataSet OBJC_DESIGNATED_INITIALIZER;
@property (nonatomic, readonly) double value;
@property (nonatomic, readonly) NSInteger dataSetIndex;
@property (nonatomic, readonly, strong) id <IChartDataSet> __nullable dataSet;
- (BOOL)isEqual:(id __nullable)object;
@end
...
- (CGPoint)getTransformedValueBarChartWithEntry:(ChartDataEntry * __nonnull)entry xIndex:(NSInteger)xIndex dataSetIndex:(NSInteger)dataSetIndex phaseY:(CGFloat)phaseY dataSetCount:(NSInteger)dataSetCount groupSpace:(CGFloat)groupSpace;

/// Transforms an Entry into a transformed point for horizontal bar chart
- (CGPoint)getTransformedValueHorizontalBarChartWithEntry:(ChartDataEntry * __nonnull)entry xIndex:(NSInteger)xIndex dataSetIndex:(NSInteger)dataSetIndex phaseY:(CGFloat)phaseY dataSetCount:(NSInteger)dataSetCount groupSpace:(CGFloat)groupSpace;
...
@property (nonatomic, strong) ChartXAxis * __nullable xAxis;
...
- (void)drawLabelsWithContext:(CGContextRef __nonnull)context pos:(CGFloat)pos anchor:(CGPoint)anchor;
- (void)drawLabelWithContext:(CGContextRef __nonnull)context label:(NSString * __nonnull)label xIndex:(NSInteger)xIndex x:(CGFloat)x y:(CGFloat)y attributes:(NSDictionary<NSString *, NSObject *> * __nonnull)attributes constrainedToSize:(CGSize)constrainedToSize anchor:(CGPoint)anchor angleRadians:(CGFloat)angleRadians;
- (void)renderGridLinesWithContext:(CGContextRef __nonnull)context;
- (void)renderLimitLinesWithContext:(CGContextRef __nonnull)context;
...
@property (nonatomic, weak) BarChartView * __nullable chart;
...
/// draws the x-labels on the specified y-position
- (void)drawLabelsWithContext:(CGContextRef __nonnull)context pos:(CGFloat)pos anchor:(CGPoint)anchor;
- (void)drawLabelWithContext:(CGContextRef __nonnull)context label:(NSString * __nonnull)label xIndex:(NSInteger)xIndex x:(CGFloat)x y:(CGFloat)y attributes:(NSDictionary<NSString *, NSObject *> * __nonnull)attributes anchor:(CGPoint)anchor angleRadians:(CGFloat)angleRadians;
- (void)renderGridLinesWithContext:(CGContextRef __nonnull)context;
- (void)renderAxisLineWithContext:(CGContextRef __nonnull)context;
- (void)renderLimitLinesWithContext:(CGContextRef __nonnull)context;
@end
...
@property (nonatomic, weak) RadarChartView * __nullable chart;
...
@property (nonatomic, strong) ChartYAxis * __nullable yAxis;
...
@property (nonatomic, weak) CombinedChartView * __nullable chart;
...
///
/// <ul><li>default: nil</li></ul>
@property (nonatomic, strong) ChartFill * __nullable fill;

/// The alpha value that is used for filling the line surface.
///
/// <ul><li>default: 0.33</li></ul>
...
- (void)drawFilledPathWithContext:(CGContextRef __nonnull)context path:(CGPathRef __nonnull)path fill:(ChartFill * __nonnull)fill fillAlpha:(CGFloat)fillAlpha;

/// Draws the provided path in filled mode with the provided color and alpha.
- (void)drawFilledPathWithContext:(CGContextRef __nonnull)context path:(CGPathRef __nonnull)path fillColor:(UIColor * __nonnull)fillColor fillAlpha:(CGFloat)fillAlpha;
@end
...
- (void)drawDataWithContext:(CGContextRef __nonnull)context;
- (void)drawDataSetWithContext:(CGContextRef __nonnull)context dataSet:(id <ILineChartDataSet> __nonnull)dataSet;
- (void)drawCubicWithContext:(CGContextRef __nonnull)context dataSet:(id <ILineChartDataSet> __nonnull)dataSet;
- (void)drawCubicFillWithContext:(CGContextRef __nonnull)context dataSet:(id <ILineChartDataSet> __nonnull)dataSet spline:(CGMutablePathRef __nonnull)spline matrix:(CGAffineTransform)matrix from:(NSInteger)from to:(NSInteger)to;
- (void)drawLinearWithContext:(CGContextRef __nonnull)context dataSet:(id <ILineChartDataSet> __nonnull)dataSet;
- (void)drawLinearFillWithContext:(CGContextRef __nonnull)context dataSet:(id <ILineChartDataSet> __nonnull)dataSet minx:(NSInteger)minx maxx:(NSInteger)maxx trans:(ChartTransformer * __nonnull)trans;
- (void)drawValuesWithContext:(CGContextRef __nonnull)context;
- (void)drawExtrasWithContext:(CGContextRef __nonnull)context;
- (void)drawHighlightedWithContext:(CGContextRef __nonnull)context indices:(NSArray<ChartHighlight *> * __nonnull)indices;
@end
...
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithXVals:(NSArray<NSObject *> * __nullable)xVals dataSets:(NSArray<id <IChartDataSet>> * __nullable)dataSets OBJC_DESIGNATED_INITIALIZER;
- (id <IChartDataSet> __nullable)getDataSetByIndex:(NSInteger)index;
- (id <IChartDataSet> __nullable)getDataSetByLabel:(NSString * __nonnull)label ignorecase:(BOOL)ignorecase;
- (void)addDataSet:(id <IChartDataSet> __null_unspecified)d;
...
/// Removes an Entry from the DataSet dynamically. This will also recalculate the current minimum and maximum values of the DataSet and the value-sum.
///
/// \param xIndex the xIndex of the entry to remove
///
/// \returns  true if the entry was removed successfully, else if the entry does not exist
- (BOOL)removeEntryWithXIndex:(NSInteger)xIndex;
...
@property (nonatomic, weak) PieChartView * __nullable chart;
...
- (void)drawDataWithContext:(CGContextRef __nonnull)context;
- (void)drawDataSetWithContext:(CGContextRef __nonnull)context dataSet:(id <IPieChartDataSet> __nonnull)dataSet;
- (void)drawValuesWithContext:(CGContextRef __nonnull)context;
- (void)drawExtrasWithContext:(CGContextRef __nonnull)context;
- (void)drawHighlightedWithContext:(CGContextRef __nonnull)context indices:(NSArray<ChartHighlight *> * __nonnull)indices;
@end
...
/// The max angle that is used for calculating the pie-circle. 360 means it's a full pie-chart, 180 results in a half-pie-chart.
///
/// <ul><li>default: 360.0</li></ul>
...
- (void)drawValuesWithContext:(CGContextRef __nonnull)context;
- (void)drawExtrasWithContext:(CGContextRef __nonnull)context;
- (void)drawWebWithContext:(CGContextRef __nonnull)context;
- (void)drawHighlightedWithContext:(CGContextRef __nonnull)context indices:(NSArray<ChartHighlight *> * __nonnull)indices;
@end
...
- (void)drawDataWithContext:(CGContextRef __nonnull)context;
- (void)drawDataSetWithContext:(CGContextRef __nonnull)context dataSet:(id <IScatterChartDataSet> __nonnull)dataSet;
- (void)drawValuesWithContext:(CGContextRef __nonnull)context;
- (void)drawExtrasWithContext:(CGContextRef __nonnull)context;
- (void)drawHighlightedWithContext:(CGContextRef __nonnull)context indices:(NSArray<ChartHighlight *> * __nonnull)indices;
@end
